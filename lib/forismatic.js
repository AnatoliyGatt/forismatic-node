/**
 * @module forismatic
 * @description Client for Forismatic API v1.0.
 * @version 1.0.3
 ...
 * @public
 * @constructor
 * @description Initialize Forismatic object with default settings.
 ...
 * @param {callback} callback - Call back when response comes in.
 */
...
Forismatic.prototype.getQuote = function(options, callback) {
    if((typeof options === "function") || (options instanceof Function)) {
        ...
        throw new Error("getQuote() must have callback function");
    }
    ...
    var request = http.get({
        ...
        response.on("end", function () {
            try {
                var parsedResponse = JSON.parse(helpers.escapeJSONString(rawResponse))
            } catch(error) {
                callback(error, null);
            }
            callback(null, helpers.deepTrimJSONObject(parsedResponse));
        });
 ...
 * @param {Object} error - Error object with default properties.
...
/**
 * @public
 * @description Expose frozen instance of Forismatic.
 * @returns {Object} - Frozen instance of Forismatic.
 */

module.exports = function() {
    return helpers.deepFreezeObject(new Forismatic());
};